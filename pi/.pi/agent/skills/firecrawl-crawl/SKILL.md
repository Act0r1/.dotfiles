...
description: Use when you should bulk extract pages from a website or section.
allowed-tools:
  - Bash(firecrawl *)
  - Bash(npx firecrawl *)
...
firecrawl crawl "<url>" --include-paths /docs --limit 50 --wait -o $HOME/.config/firecrawl/.firecrawl/crawl.json

# Full crawl with depth limit
firecrawl crawl "<url>" --max-depth 3 --wait --progress -o $HOME/.config/firecrawl/.firecrawl/crawl.json
