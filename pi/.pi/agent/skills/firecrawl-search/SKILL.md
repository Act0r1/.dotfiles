...
description: Use when you should search the web and optionally scrape result pages.
allowed-tools:
  - Bash(firecrawl *)
  - Bash(npx firecrawl *)
...
```bash
# Basic search
firecrawl search "your query" -o $HOME/.config/firecrawl/.firecrawl/result.json --json

# Search and scrape full page content from results
firecrawl search "your query" --scrape -o $HOME/.config/firecrawl/.firecrawl/scraped.json --json

# News from the past day
firecrawl search "your query" --sources news --tbs qdr:d -o $HOME/.config/firecrawl/.firecrawl/news.json --json
```
...
- Always write results to `$HOME/.config/firecrawl/.firecrawl/` with `-o` to avoid context window bloat.
- Use `jq` to extract URLs or titles: `jq -r '.data.web[].url' $HOME/.config/firecrawl/.firecrawl/search.json`
- Naming convention: `$HOME/.config/firecrawl/.firecrawl/search-{query}.json` or `$HOME/.config/firecrawl/.firecrawl/search-{query}-scraped.json`
...
```bash
SEARCH_ID=$(jq -r '.id' $HOME/.config/firecrawl/.firecrawl/search-react-hooks.json)
```
