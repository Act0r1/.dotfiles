...
Scope {
    ...
    Variants {
        ...
        PanelWindow {
            ...
            function switchRelativeWorkspace(step: int): void {
            ...
            Column {
                ...
                Keys.onPressed: event => {
                    if (event.key === Qt.Key_Escape && root.orbitMode && root.orbitStudioOpen) {
                        ...
                        event.accepted = true
                            ...
                            || (!root.orbitMode && event.key === Qt.Key_Up
                        ...
                        if (!root.searchingText) {
                            ...
                            || (!root.orbitMode && event.key === Qt.Key_Down
                                && event.modifiers === Qt.NoModifier)
                ...
                SearchWidget {
                    ...
                    onWorkspaceNavigationRequested: step => {
                        if (!root.orbitMode && !root.searchingText)
                            root.switchRelativeWorkspace(step)
                    }
                }
